...
class BrandTest extends TestCase
{
    ...
    public function test_get_brands_unauthenticated(): void
    {
    ...
    public function test_get_brands_unauthorized(): void
    {
    ...
    public function test_get_brand_unauthenticated(): void
    {
    ...
    public function test_get_brand_unauthorized(): void
    {
        $user = User::factory()->create(['is_admin' => false]);
